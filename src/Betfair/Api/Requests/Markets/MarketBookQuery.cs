...
public class MarketBookQuery
{
    ...
    /// </summary>
    public OrderStatus? OrderProjection { get; private set; }
    ...
    /// <returns>This <see cref="MarketBookQuery"/>.</returns>
    public MarketBookQuery WithOrderProjection(OrderStatus orderProjection)
    {
    ...
    {
        OrderProjection = OrderStatus.All;
        return this;
    }
    ...
    {
        MatchProjection = Core.Enums.MatchProjection.NoRollup;
        return this;
    }
    ...
    {
        MatchProjection = Core.Enums.MatchProjection.RolledUpByPrice;
        return this;
    }
    ...
    {
        MatchProjection = Core.Enums.MatchProjection.RolledUpByAvgPrice;
        return this;
    }
}
