...
public class PlaceInstructionReport
{
    ...
    /// <summary>
    /// Gets the size matched for the bet.
    /// Will be null if the order was placed asynchronously.
    /// </summary>
    ...
    /// <summary>
    /// Gets the place instruction associated with the report.
