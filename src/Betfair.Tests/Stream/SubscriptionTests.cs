...
public class SubscriptionTests
{
    ...
    public async Task AuthenticatesWhenFirstMarketSubscriptionIsMade()
    {
        ...
        await sub.Subscribe(filter, cancellationToken: CancellationToken.None);
    ...
    public async Task AuthenticatesWhenFirstOrderSubscriptionIsMade()
    {
        ...
        await sub.SubscribeToOrders(cancellationToken: CancellationToken.None);
    ...
    public async Task SubscribeWritesTheDataFilterToTheStream()
    {
        ...
        await sub.Subscribe(marketFilter, dataFilter, cancellationToken: CancellationToken.None);
    ...
    public async Task SubscribeWritesTheConflateRateToTheStream(int conflateMs)
    {
        ...
        await sub.Subscribe(marketFilter, conflate: TimeSpan.FromMilliseconds(conflateMs), cancellationToken: CancellationToken.None);
    ...
    public async Task CapturesClockTokensFromChangeMessages()
    {
        ...
        await foreach (var msg in sub.ReadLines(CancellationToken.None)) last = msg;
    ...
    public async Task SubscribeWithResumeTokensWritesClkFields()
    {
        ...
        await sub.Subscribe(filter, initialClk: "ic", clk: "c", cancellationToken: CancellationToken.None);
    ...
    public async Task SubscribeToOrderWritesOrderFilterToTheStream(string strategyRef)
    {
        ...
        await sub.SubscribeToOrders(orderFilter, cancellationToken: CancellationToken.None);
    ...
    public async Task SubscribeToOrderWritesTheConflateRateToTheStream(int conflateMs)
    {
        ...
        await sub.SubscribeToOrders(conflate: TimeSpan.FromMilliseconds(conflateMs), cancellationToken: CancellationToken.None);
    ...
    public async Task ChangeMessagesAreReadFromTheStream()
    {
        ...
        await foreach (var line in sub.ReadLines(CancellationToken.None))
            read.Add(line);
