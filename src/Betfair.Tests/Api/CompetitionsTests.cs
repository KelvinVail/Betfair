...
public class CompetitionsTests : IDisposable
{
    ...
    {
        await _api.Competitions(cancellationToken: CancellationToken.None);
    ...
    public async Task PostsFilterIfProvided()
    {
        ...
        await _api.Competitions(filter, cancellationToken: CancellationToken.None);
    ...
    public async Task ResponseShouldBeDeserializable()
    {
        ...
        var response = await _api.Competitions(cancellationToken: CancellationToken.None);
