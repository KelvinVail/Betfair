...
public class EventTypeTests : IDisposable
{
    ...
    {
        await _api.EventTypes(cancellationToken: CancellationToken.None);
    ...
    public async Task RequestBodyShouldBeSerializable()
    {
        ...
        await _api.EventTypes(filter, cancellationToken: CancellationToken.None);
    ...
    public async Task ResponseShouldBeDeserializable()
    {
        ...
        var response = await _api.EventTypes(cancellationToken: CancellationToken.None);
