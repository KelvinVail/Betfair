...
public class MarketProfitAndLossTests : IDisposable
{
    ...
    {
        await _api.MarketProfitAndLoss(["1.2345"], cancellationToken: CancellationToken.None);
    ...
    {
        await _api.MarketProfitAndLoss([marketId], cancellationToken: CancellationToken.None);
    ...
    {
        await _api.MarketProfitAndLoss(["1.2345"], includeSettledBets: true, cancellationToken: CancellationToken.None);
    ...
    {
        await _api.MarketProfitAndLoss(["1.2345"], includeBspBets: true, cancellationToken: CancellationToken.None);
    ...
    {
        await _api.MarketProfitAndLoss(["1.2345"], netOfCommission: true, cancellationToken: CancellationToken.None);
    ...
    {
        await _api.MarketProfitAndLoss(["1.23456789"], includeSettledBets: true, includeBspBets: true, netOfCommission: true, cancellationToken: CancellationToken.None);
    ...
    public async Task ResponseShouldBeDeserializable()
    {
        ...
        var response = await _api.MarketProfitAndLoss(["1.23456789"], cancellationToken: CancellationToken.None);
