namespace Betfair.Betting.Tests
{
    ...
    public class LimitOrderTests
    {
        ...
        [InlineData(0.01, 1.8)]
        [InlineData(0.02, 1.4)]
        [InlineData(0.03, 1.27)]
        [InlineData(0.04, 1.2)]
        [InlineData(0.05, 1.16)]
        [InlineData(0.06, 1.14)]
        [InlineData(0.07, 1.12)]
        [InlineData(0.08, 1.1)]
        [InlineData(0.09, 1.09)]
        [InlineData(0.1, 1.08)]
        [InlineData(0.11, 1.08)]
        [InlineData(0.12, 1.07)]
        [InlineData(0.13, 1.07)]
        [InlineData(0.14, 1.06)]
        [InlineData(0.15, 1.06)]
        [InlineData(0.16, 1.05)]
        [InlineData(0.17, 1.05)]
        [InlineData(0.18, 1.05)]
        [InlineData(0.19, 1.05)]
        [InlineData(0.2, 1.04)]
        [InlineData(0.21, 1.04)]
        [InlineData(0.22, 1.04)]
        [InlineData(0.23, 1.04)]
        [InlineData(0.24, 1.04)]
        [InlineData(0.25, 1.04)]
        [InlineData(0.26, 1.04)]
        [InlineData(0.27, 1.03)]
        [InlineData(0.28, 1.03)]
        [InlineData(0.29, 1.03)]
        [InlineData(0.3, 1.03)]
        [InlineData(0.31, 1.03)]
        [InlineData(0.32, 1.03)]
        [InlineData(0.33, 1.03)]
        [InlineData(0.34, 1.03)]
        [InlineData(0.35, 1.03)]
        [InlineData(0.36, 1.03)]
        [InlineData(0.37, 1.03)]
        [InlineData(0.38, 1.03)]
        [InlineData(0.39, 1.03)]
        [InlineData(0.4, 1.02)]
        [InlineData(0.41, 1.02)]
        [InlineData(0.42, 1.02)]
        [InlineData(0.43, 1.02)]
        [InlineData(0.44, 1.02)]
        [InlineData(0.45, 1.02)]
        [InlineData(0.46, 1.02)]
        [InlineData(0.47, 1.02)]
        [InlineData(0.48, 1.02)]
        [InlineData(0.49, 1.02)]
        [InlineData(0.5, 1.02)]
        [InlineData(0.51, 1.02)]
        [InlineData(0.52, 1.02)]
        [InlineData(0.53, 1.02)]
        [InlineData(0.54, 1.02)]
        [InlineData(0.55, 1.02)]
        [InlineData(0.56, 1.02)]
        [InlineData(0.57, 1.02)]
        [InlineData(0.58, 1.02)]
        [InlineData(0.59, 1.02)]
        [InlineData(0.6, 1.02)]
        [InlineData(0.61, 1.02)]
        [InlineData(0.62, 1.02)]
        [InlineData(0.63, 1.03)]
        [InlineData(0.64, 1.03)]
        [InlineData(0.65, 1.03)]
        [InlineData(0.66, 1.03)]
        [InlineData(0.67, 1.03)]
        [InlineData(0.68, 1.03)]
        [InlineData(0.69, 1.03)]
        [InlineData(0.7, 1.03)]
        [InlineData(0.71, 1.03)]
        [InlineData(0.72, 1.03)]
        [InlineData(0.73, 1.03)]
        [InlineData(0.74, 1.03)]
        [InlineData(0.75, 1.03)]
        [InlineData(0.76, 1.03)]
        [InlineData(0.77, 1.03)]
        [InlineData(0.78, 1.03)]
        [InlineData(0.79, 1.03)]
        [InlineData(0.8, 1.01)]
        [InlineData(0.81, 1.01)]
        [InlineData(0.82, 1.01)]
        [InlineData(0.83, 1.01)]
        [InlineData(0.84, 1.01)]
        [InlineData(0.85, 1.01)]
        [InlineData(0.86, 1.01)]
        [InlineData(0.87, 1.01)]
        [InlineData(0.88, 1.01)]
        [InlineData(0.89, 1.01)]
        [InlineData(0.9, 1.01)]
        [InlineData(0.91, 1.01)]
        [InlineData(0.92, 1.01)]
        [InlineData(0.93, 1.01)]
        [InlineData(0.94, 1.01)]
        [InlineData(0.95, 1.01)]
        [InlineData(0.96, 1.01)]
        [InlineData(0.97, 1.01)]
        [InlineData(0.98, 1.01)]
        [InlineData(0.99, 1.01)]
        [InlineData(1, 1.01)]
        [InlineData(1.01, 1.01)]
        [InlineData(1.02, 1.01)]
        [InlineData(1.03, 1.01)]
        [InlineData(1.04, 1.01)]
        [InlineData(1.05, 1.01)]
        [InlineData(1.06, 1.01)]
        [InlineData(1.07, 1.01)]
        [InlineData(1.08, 1.01)]
        [InlineData(1.09, 1.01)]
        [InlineData(1.1, 1.01)]
        [InlineData(1.11, 1.01)]
        [InlineData(1.12, 1.01)]
        [InlineData(1.13, 1.01)]
        [InlineData(1.14, 1.01)]
        [InlineData(1.15, 1.01)]
        [InlineData(1.16, 1.01)]
        [InlineData(1.17, 1.01)]
        [InlineData(1.18, 1.01)]
        [InlineData(1.19, 1.01)]
        [InlineData(1.2, 1.01)]
        [InlineData(1.21, 1.01)]
        [InlineData(1.22, 1.01)]
        [InlineData(1.23, 1.01)]
        [InlineData(1.24, 1.01)]
        [InlineData(1.25, 1.02)]
        [InlineData(1.26, 1.02)]
        [InlineData(1.27, 1.02)]
        [InlineData(1.28, 1.02)]
        [InlineData(1.29, 1.02)]
        [InlineData(1.3, 1.02)]
        [InlineData(1.31, 1.02)]
        [InlineData(1.32, 1.02)]
        [InlineData(1.33, 1.02)]
        [InlineData(1.34, 1.02)]
        [InlineData(1.35, 1.02)]
        [InlineData(1.36, 1.02)]
        [InlineData(1.37, 1.02)]
        [InlineData(1.38, 1.02)]
        [InlineData(1.39, 1.02)]
        [InlineData(1.4, 1.02)]
        [InlineData(1.41, 1.02)]
        [InlineData(1.42, 1.02)]
        [InlineData(1.43, 1.02)]
        [InlineData(1.44, 1.02)]
        [InlineData(1.45, 1.02)]
        [InlineData(1.46, 1.02)]
        [InlineData(1.47, 1.02)]
        [InlineData(1.48, 1.02)]
        [InlineData(1.49, 1.02)]
        [InlineData(1.5, 1.02)]
        [InlineData(1.51, 1.02)]
        [InlineData(1.52, 1.02)]
        [InlineData(1.53, 1.02)]
        [InlineData(1.54, 1.02)]
        [InlineData(1.55, 1.02)]
        [InlineData(1.56, 1.02)]
        [InlineData(1.57, 1.02)]
        [InlineData(1.58, 1.02)]
        [InlineData(1.59, 1.02)]
